...
MODEL_ROUTE    = os.getenv("ASSISTANT_MODEL_ROUTE",    "gemini-3-flash-preview")  # 意图分类主模型（快）
MODEL_CHAT     = os.getenv("ASSISTANT_MODEL_CHAT",     "gemini-3.5-flash")        # 通用对话（更强推理）
MODEL_COMPRESS = os.getenv("ASSISTANT_MODEL_COMPRESS", "gemini-3-flash-preview")  # 摘要压缩（便宜）
