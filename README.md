...
### 🆕 官方 MCP 支持进展(2026-09-13)

**同花顺(HiThink)官方 MCP · 已实测通过**

- 官方文档站公开列出的 `fuyao.aicubes.cn/mcp/*` 系列 MCP 端点(A 股、指数、基金、期货、期权、元数据 6 个)
- 用户在文档站三步申请自己的 API Key · 请求头带 `X-api-key`
- 我们用真 key 端到端实测通过:数据准确、与三方对账一致、限流宽松
- 落在 hunter 的「玩法 ②:自接 MCP」路径下 —— **你填自己的 key,我们代码零密钥**
- ⚠️ 同花顺 387KB 文档搜不到「商用/转售/再分发」条款 · **商用前请自行向官方确认**

**通达信(TDX)· 暂未开放官方文档化的 MCP 接入 · 我们在等**

- 通达信也有 MCP 服务 · 但**官方目前没有对外公开授权的 API 地址与开发者文档**
- 出于合规考虑,hunter-community **不集成任何未公开授权的通达信接口**
- 我们正在与通达信官方沟通 · **期待通达信能支持我们的开源产品** —— 让已购买付费 key 的用户 · 能正常把通达信 MCP 接入 hunter-community 使用
- 通达信的同学如果看到 · 欢迎通过 GitHub Issues 或邮件联系我们

**详细文章**:[www.agentpit.io/blog/ths-tdx-official-mcp-field-test](https://www.agentpit.io/blog/ths-tdx-official-mcp-field-test)
